...
const pageTitles: Record<Tab, string> = {
    ...
    "recovery-phrases": "Manage Recovery Phrase",
            ...
            <aside className="dashboard-sidebar d-flex flex-column justify-content-between">
                <div>
                    ...
                    <nav className="sidebar-nav-container">
                        ...
                        {user.isSubscribed && (
                            <>
                                <hr className="mx-3 my-3" style={{ borderColor: "#1f2833", opacity: 1 }} />

                                <div 
                                    className="sidebar-section-divider mb-2 px-3 text-uppercase font-monospace" 
                                    style={{ fontSize: "13px", letterSpacing: "1px", fontWeight: "bold", color: "#ffffff" }}
                                >
                                    Premium Features
                                </div>
